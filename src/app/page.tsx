      ...
      <main className="flex-1">
        ...
        <section className="py-24 md:py-32 px-6 text-center max-w-5xl mx-auto space-y-8">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground/80 max-w-3xl mx-auto leading-relaxed">
            Elimine o risco de vazamento de dados. Ofereça aos seus colaboradores o poder do GPT-4, Claude e DeepSeek em um ambiente 100% monitorado, criptografado e auditável.
          </p>
          ...
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="bg-background/60 backdrop-blur-sm border-muted-foreground/10 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-muted-foreground leading-relaxed">
                    &quot;Bring Your Own Key&quot;. Conecte diretamente suas chaves da OpenAI, Anthropic ou DeepSeek. Não atuamos como intermediários opacos; você paga apenas pelo gerenciamento e segurança.
                  </p>
                </CardContent>
              </Card>
