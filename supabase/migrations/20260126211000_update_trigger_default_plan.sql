-- Atualiza trigger para definir o Plano STARTER por padrão
...
declare
  ...
  -- ID do Plano Starter (fixo no seed_plans.sql)
  starter_plan_id uuid := '11111111-1111-1111-1111-111111111111';
begin
  ...
  if company_name is not null then
    -- Cria empresa já vinculada ao plano Starter
    insert into public.companies (name, plan_id)
    values (company_name, starter_plan_id)
